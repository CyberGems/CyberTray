export const translations = {
  en: {
    ...
    app_layout_desc: "Icon size, grid or list view, and sort order for the shelf.",
    ...
    general_hotspots_corners_desc: "Select one or more screen corners to show or hide CyberTray when hovering the cursor.",
  ...
  es: {
    ...
    general_hotspots_corners_desc: "Selecciona una o más esquinas para mostrar u ocultar CyberTray al llevar el cursor allí.",
